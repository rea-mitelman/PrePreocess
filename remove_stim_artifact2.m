function clean_signal=remove_stim_artifact(raw_signal,raw_signal_Fs,stim_times,org_art_dur)
%
% clean_signal=remove_stim_artifact(raw_signal,raw_signal_Fs,stim_time,stim_time_Fs,art_dur) 
% 
...
% t=art_dir, the subtraction value is decayed linearly to zero (i.e., at
